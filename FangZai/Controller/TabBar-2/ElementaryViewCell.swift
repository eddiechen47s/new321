...
class ElementaryViewCell: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    
    fileprivate let cellId = "cellId"
    let viewModel: [CountrySchoolModels] = [CountrySchoolModels(school: "縣立玉田國小"),
                     CountrySchoolModels(school: "縣立玉田國小"),
                      CountrySchoolModels(school: "縣立玉田國小")
    ]
