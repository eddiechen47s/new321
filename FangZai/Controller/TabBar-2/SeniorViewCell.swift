...
class SeniorViewCell: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    
    fileprivate let cellId = "cellId"
    let viewModel: [CountrySchoolModels] = [CountrySchoolModels(school: "縣立桃園高工"),
                     CountrySchoolModels(school: "縣立桃園高工"),
                      CountrySchoolModels(school: "縣立桃園高工")
    ]
    ...
    override init(frame: CGRect) {
        ...
        collectionView.register(SeniorCell.self, forCellWithReuseIdentifier: cellId)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! SeniorCell
