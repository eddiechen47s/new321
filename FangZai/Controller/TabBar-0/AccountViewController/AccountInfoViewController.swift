...
class AccountInfoViewController: UIViewController {
    ...
    func setNavRightBar() {
        let rightBarItem = UIBarButtonItem(title: "編輯", style: .plain, target: self, action: #selector(toEditViewAction))
    ...
    @objc func toEditViewAction() {
        ...
        let controller = storyBoard.instantiateViewController(withIdentifier: "AccountInfoEditVC") as! AccountInfoEditViewController
